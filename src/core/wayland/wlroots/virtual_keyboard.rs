...
use crate::core::state::{CompositorState, VirtualKeyboardState};
use crate::core::wayland::wlroots::zwp_virtual_keyboard_v1::{
    ...
    fn request(
        ...
        match request {
            zwp_virtual_keyboard_manager_v1::Request::CreateVirtualKeyboard { seat, id } => {
                ...
                state.add_virtual_keyboard(resource_id, keyboard_state);
            }
            _ => {}
        }
    }
    ...
    fn request(
        ...
        match request {
            ...
            zwp_virtual_keyboard_v1::Request::Destroy => {
                ...
                state.remove_virtual_keyboard(resource_id);
            }
            _ => {}
        }
    }
