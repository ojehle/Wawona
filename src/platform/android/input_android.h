...
/**
 * Map an ASCII character to its Linux evdev keycode (matches iOS
 * charToLinuxKeycode).  Sets *needs_shift = 1 when the character requires
 * Shift.  Returns 0 for non-ASCII / unmapped chars.
 */
